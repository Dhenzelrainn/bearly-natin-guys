...
<title>Logistics Login | Bearly</title>
...
<div>
<div class="eyebrow">Approved Logistics Partners</div>
<h1>Manage the movement behind every delivery.</h1>
<p>Access rider management, seller pickup verification, parcel intake, sorting, dispatch, delivery monitoring, reports, and messages.</p>
</div>
...
<p class="muted">Sign in after your company application has been approved by the Bearly Administrator.</p>
@if ($errors->any())
...
<div class="full"><button class="btn btn-primary" style="width:100%" type="submit">Sign In to Logistics Center</button></div>
</div>
</form>
<div class="divider"></div>
<p class="small muted">Not registered yet? <a href="{{ route('logistics.register') }}" style="color:var(--orange);font-weight:700">Apply as Logistics</a></p>
</div>
</section>
</div>
</body>
