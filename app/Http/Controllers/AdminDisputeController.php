    ...
    public function sendUpdate(
        ...
        $result = DB::transaction(function () use (
            ...
            if (in_array(
                ...
                throw ValidationException::withMessages([
                    'dispute' => 'A finalized dispute cannot receive participant updates.',
                ]);
            }
            ...
            if ($participants->isEmpty()) {
                throw ValidationException::withMessages([
                    'participants' => 'This dispute has no active participants to notify.',
                ]);
            }
            ...
            $this->auditService->record(
                action: 'dispute.participant_update_sent',

                module: 'Compliance & Disputes',

                subject: $dispute,

                description: "Participant update sent for {$dispute->dispute_no}.",
        ...
        return response()->json([
            'message' => 'Case update sent to dispute participants.',
    ...
    public function downloadEvidence(
        ...
        */
        ...
        $this->auditService->record(
            ...
            subject: $evidence->dispute,

            description: "Evidence downloaded for {$evidence->dispute->dispute_no}.",
