...
<section class="report-filter-bar panel">
    ...
    <label class="form-field inline-filter"><span>Report type</span><select class="select-field" data-report-type><option>Sales Summary</option><option>Commission Report</option></select></label>
...
<section class="panel" data-report-section="commission">
