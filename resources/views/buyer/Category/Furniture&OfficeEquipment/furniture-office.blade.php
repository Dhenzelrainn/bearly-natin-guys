@php
    $catalog = json_decode(
        file_get_contents(resource_path('data/buyer-furniture-office-products.json')),
        true,
        512,
        JSON_THROW_ON_ERROR
    );
    ...
    $furnitureOfficeCategory = collect($taxonomy)->firstWhere('slug', 'furniture-and-office-equipment');

    $subcategories = $furnitureOfficeCategory['subcategories'] ?? [
        'Home Furniture',
        'Office Furniture',
        'Office Equipment',
        'Office Accessories',
...
<head>
    ...
    <title>Furniture & Office Equipment | Bearly</title>
...
<body class="bc" style="--catalog-image:url('{{ asset('images/furniture-office-catalog-atlas.png') }}')">
    ...
    <header class="bc-header">
        ...
        <form id="bc-search-form" class="search" role="search">
            <span>Furniture & Office Equipment</span>

            <label class="sr" for="bc-search">Search Furniture & Office Equipment</label>
            <input id="bc-search" type="search" placeholder="Search Furniture & Office Equipment" maxlength="120">
    ...
    <div class="bc-shell">
        <aside class="bc-sidebar" id="bc-sidebar" aria-label="Categories and filters">
            ...
            <div class="active-category">
                <i class="mi" aria-hidden="true">chair</i>
                <strong>Furniture & Office Equipment</strong>
            </div>
                    ...
                    @foreach($subcategories as $i => $sub)
                        <button data-sub="{{ $sub }}" aria-pressed="false">
                            <i class="mi" aria-hidden="true">
                                {{ ['weekend','chair','computer','inventory_2','shelves','light'][$i] ?? 'chair' }}
                            </i>
                            {{ $sub }}
                        </button>
                    @endforeach
            ...
            @include('buyer.Category.Furniture&OfficeEquipment.components.furniture-office-filter')
        </aside>
        ...
        <main id="bc-main" tabindex="-1">
            ...
            <h1>Furniture & Office Equipment</h1>

            <p class="subtitle">
                Furniture and office essentials for home, study, and work.
            </p>
            ...
            <div class="shortcuts" aria-label="Explore subcategories">
                @php
                    $shortcutPhotos = [0, 7, 20, 14, 18, 15];
                @endphp
    ...
    <dialog id="bc-mobile-dialog" aria-labelledby="bc-mobile-title">
        <div class="mobile-heading">
            <div>
                ...
                <p>Furniture & Office Equipment</p>
            </div>
    ...
    @include('buyer.Category.Furniture&OfficeEquipment.components.furniture-office-product-card')
