...
<body class="bh" style="--buyer-product-atlas: url('{{ asset('images/buyer/product-atlas.png') }}')">
...
<header class="header">
    ...
    <a class="brand" href="{{ url('/home') }}" aria-label="Bearly home"><img src="{{ asset('images/buyer/bearly-logo.png') }}" alt="Bearly" width="192" height="64"></a>
    ...
    <main id="main" tabindex="-1">
        <div id="editorial">
            <section class="hero" aria-labelledby="hero-title">
                <img class="hero-image" src="{{ asset('images/buyer/marketplace-hero.png') }}" alt="Headphones, sneakers, a tote bag and desk essentials on warm stone displays" fetchpriority="high" width="1536" height="1024">
