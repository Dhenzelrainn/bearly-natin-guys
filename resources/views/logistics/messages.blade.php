...
<div class="page-intro"><div><span class="eyebrow">Communication</span><h2>Seller, Rider & Admin Messaging</h2><p>Coordinate operational concerns without leaving the module. Chat changes stay active in the current front-end session.</p></div></div>
