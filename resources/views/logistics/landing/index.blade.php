...
<title>Logistics Partner | Bearly</title>
...
<div>
<div class="eyebrow">Logistics / Sorting Center</div>
<h1>Become a Bearly logistics partner.</h1>
<p>Companies such as J&T, SPX, or another sorting-center operator apply directly to Bearly. Applications are reviewed by the Administrator before a Logistics account becomes active.</p>
</div>
<p class="small">Bearly E-Commerce ERP · Logistics & Delivery Network</p>
</section>
<section class="panel">
<div class="card">
<h2>Logistics Partner Portal</h2>
<p class="muted">For sorting centers and logistics companies that want to operate within Bearly.</p>
<div class="actions">
<a class="btn btn-primary" href="{{ route('logistics.register') }}">Apply as a Logistics Partner</a>
<a class="btn btn-secondary" href="{{ route('logistics.login') }}">Logistics Login</a>
</div>
<div class="feature"><div class="dot">1</div><div><b>Submit company application</b><span class="muted small">Provide representative details, business address, valid ID, and business permit.</span></div></div>
<div class="feature"><div class="dot">2</div><div><b>Administrator verification</b><span class="muted small">Bearly Admin reviews the logistics application and credentials.</span></div></div>
<div class="feature"><div class="dot">3</div><div><b>Operate your sorting center</b><span class="muted small">Approved partners can manage riders, pickups, sorting, dispatch, and monitoring.</span></div></div>
<div class="divider"></div>
<p class="small muted">Are you an individual delivery rider? <a href="{{ route('rider.landing') }}" style="color:var(--orange);font-weight:700">Go to Rider Portal →</a></p>
</div>
</section>
</div>
</body>
