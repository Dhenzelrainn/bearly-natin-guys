@php
    ...
    $booksMediaCategory = collect($taxonomy)->firstWhere('slug', 'books-and-media');

    $subcategories = $booksMediaCategory['subcategories'] ?? [
        'Books',
        'Nonfiction',
        'Children & Education',
...
<head>
    ...
    <title>Books & Media | Bearly</title>
...
<body class="bc" style="--catalog-image:url('{{ asset('images/books-media-catalog-atlas.png') }}')">
    ...
    <header class="bc-header">
        ...
        <form id="bc-search-form" class="search" role="search">
            ...
            <label class="sr" for="bc-search">Search Books & Media</label>
            <input id="bc-search" type="search" placeholder="Search Books & Media" maxlength="120">
    ...
    <div class="bc-shell">
        <aside class="bc-sidebar" id="bc-sidebar" aria-label="Categories and filters">
            ...
            <div class="active-category">
                <i class="mi" aria-hidden="true">menu_book</i>
                    ...
                    @foreach($subcategories as $i => $sub)
                        <button data-sub="{{ $sub }}" aria-pressed="false">
                            <i class="mi" aria-hidden="true">
                                {{ ['menu_book','auto_stories','school','comic_bubble','movie','extension'][$i] ?? 'menu_book' }}
                            </i>
                            {{ $sub }}
                        </button>
                    @endforeach
            ...
            @include('buyer.Category.Books&Media.components.books-media-filter')
        </aside>
        ...
        <main id="bc-main" tabindex="-1">
            ...
            <p class="subtitle">
                Stories, learning, entertainment, and media picks for every interest.
            </p>
