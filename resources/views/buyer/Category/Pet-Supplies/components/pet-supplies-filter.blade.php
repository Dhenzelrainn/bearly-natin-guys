<section id="bc-filter-panel" class="filter-panel" aria-label="Product filters">
    <div class="filter-heading">
        <h2><i class="mi" aria-hidden="true">tune</i> Filters</h2>
        <button id="bc-collapse" aria-expanded="true">Collapse all</button>
    </div>
    <label class="category-search">
        <i class="mi" aria-hidden="true">search</i>
        <input type="search" id="bc-within" placeholder="Search within Pet Supplies" aria-label="Search within Pet Supplies" maxlength="120">
    </label>
    <div class="selected">
        <strong id="bc-selected">Selected (0)</strong>
        <button data-reset>Clear all</button>
    </div>
    ...
    <details open>
        ...
        <div class="price-fields">
            <label><span>₱ Min</span><input id="bc-min" type="number" min="0" max="5000" step="1" placeholder="0"></label>
            <label><span>₱ Max</span><input id="bc-max" type="number" min="0" max="5000" step="1" placeholder="5000"></label>
        </div>
        <div class="ranges">
    ...
    <details open>
        ...
        <div class="size-options" id="bc-size-options"></div>
    </details>

    <details open>
        <summary>Color</summary>
        <div class="colors" id="bc-color-options"></div>
    </details>
    <details open>
        <summary>Condition</summary>
        <div class="checks" id="bc-condition-options"></div>
    </details>
    <details open>
        <summary>Seller location</summary>
        <input type="search" id="bc-location-search" placeholder="Find a location" aria-label="Find a seller location">
        <div class="checks" id="bc-location-options"></div>
    </details>
