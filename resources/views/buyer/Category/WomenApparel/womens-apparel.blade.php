@php
    ...
    $womensCategory = collect($taxonomy)->firstWhere('slug', 'women-s-apparel');
    $subcategories = $womensCategory['subcategories'];
@endphp
...
<head>
    ...
    <title>Women's Apparel | Bearly</title>
...
<body class="bc" style="--catalog-image:url('{{ asset('images/womens-catalog-atlas.png') }}')">
    ...
    <header class="bc-header">
        ...
        <form id="bc-search-form" class="search" role="search">
            ...
            <label class="sr" for="bc-search">Search Women's Apparel</label>
            <input id="bc-search" type="search" placeholder="Search Women's Apparel" maxlength="120">
    ...
    <div class="bc-shell">
        <aside class="bc-sidebar" id="bc-sidebar" aria-label="Categories and filters">
            ...
            <div class="active-category">
                <i class="mi" aria-hidden="true">checkroom</i>
                <strong>Women's Apparel</strong>
            </div>
                    ...
                    @foreach($subcategories as $i => $sub)
                        <button data-sub="{{ $sub }}" aria-pressed="false">
                            <i class="mi" aria-hidden="true">
                                {{ ['styler','checkroom','fitness_center','bedtime','apparel','steps'][$i] }}
                            </i>
                            {{ $sub }}
                        </button>
                    @endforeach
            ...
            @include('buyer.Category.WomenApparel.components.womens-apparel-filter')
        </aside>
        ...
        <main id="bc-main" tabindex="-1">
            ...
            <p class="subtitle">
                Fresh looks, everyday comfort, your style.
            </p>
