<section id="bc-filter-panel" class="filter-panel" aria-label="Product filters">
    ...
    <details open>
        ...
        <div class="presets">
            <button data-price="0,499">Under ₱500</button>
            <button data-price="500,1000">₱500–₱1,000</button>
            <button data-price="1001,5000">Over ₱1,000</button>
        </div>
    </details>

    <details open>
        <summary>Size / Capacity</summary>
    ...
    <details open>
        ...
        <small>Sample ratings for filter testing</small>
    </details>
</section>
