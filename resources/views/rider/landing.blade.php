...
<title>Rider Portal | Bearly</title>
...
<div>
<div class="eyebrow">Delivery Rider</div>
<h1>Ride with a Bearly logistics partner.</h1>
<p>Riders do not apply directly to Bearly Admin. Your application is submitted to the Logistics / Sorting Center you choose, and that partner approves your Rider account.</p>
</div>
...
<div class="card">
<h2>Rider Portal</h2>
<p class="muted">For individual riders applying under an approved Bearly Logistics / Sorting Center partner.</p>
<div class="actions">
<a class="btn btn-primary" href="{{ route('rider.register') }}">Register as a Rider</a>
<a class="btn btn-secondary" href="{{ route('rider.login') }}">Rider Login</a>
</div>
<div class="feature"><div class="dot">1</div><div><b>Select your Logistics partner</b><span class="muted small">Choose the sorting center or logistics company you are applying under.</span></div></div>
<div class="feature"><div class="dot">2</div><div><b>Submit rider credentials</b><span class="muted small">Provide vehicle details, OR/CR, and Driver License or valid ID.</span></div></div>
<div class="feature"><div class="dot">3</div><div><b>Logistics approval</b><span class="muted small">Your selected Logistics partner verifies and activates your Rider account.</span></div></div>
<div class="divider"></div>
<p class="small muted">Representing a logistics company? <a href="{{ route('logistics.landing') }}" style="color:var(--orange);font-weight:700">Go to Logistics Portal →</a></p>
</div>
</section>
</div>
</body>
