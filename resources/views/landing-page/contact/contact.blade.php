...
<header class="bl-header contact-header">
    ...
    <div class="bl-actions">
        ...
        <a href="{{ route('shop.home') }}" aria-label="Saved products">
            <span class="material-symbols-outlined" aria-hidden="true">favorite</span>
        </a>

        <a href="{{ route('shop.home') }}" aria-label="Shopping cart">
            <span class="material-symbols-outlined" aria-hidden="true">shopping_cart</span>
        </a>
    </div>

    <form class="bl-search" action="{{ route('shop.home') }}" method="GET" role="search">
        ...
        <div class="contact-shell contact-shortcut-grid">
            <article class="contact-shortcut-card">
                ...
                <div class="contact-shortcut-actions">
                    <a class="contact-primary-button contact-small-button" href="{{ route('shop.home') }}">
                        View orders
                    </a>
...
<footer class="bl-footer">
    <div class="bl-footer-grid">
        ...
        <nav aria-label="Shop links">
            <h3>Shop</h3>
            <a href="{{ route('shop.home') }}">All Products</a>
