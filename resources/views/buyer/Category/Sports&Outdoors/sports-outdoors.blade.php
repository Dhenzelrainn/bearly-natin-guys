@php
    $catalog = json_decode(
        file_get_contents(resource_path('data/buyer-sports-products.json')),
        true,
        512,
        JSON_THROW_ON_ERROR
    );
    ...
    $sportsCategory = collect($taxonomy)->firstWhere('slug', 'sports-and-outdoors');

    $subcategories = $sportsCategory['subcategories'] ?? [
        'Team Sports',
        'Fitness & Training',
        'Camping & Hiking',
        'Racquet Sports',
...
<head>
    ...
    <title>Sports & Outdoors | Bearly</title>
...
<body class="bc" style="--catalog-image:url('{{ asset('images/sports-outdoors-catalog-atlas.png') }}')">
    ...
    <header class="bc-header">
        ...
        <form id="bc-search-form" class="search" role="search">
            ...
            <label class="sr" for="bc-search">Search Sports & Outdoors</label>
            <input id="bc-search" type="search" placeholder="Search Sports & Outdoors" maxlength="120">
    ...
    <div class="bc-shell">
        <aside class="bc-sidebar" id="bc-sidebar" aria-label="Categories and filters">
            ...
            <div class="active-category">
                <i class="mi" aria-hidden="true">sports_basketball</i>
            ...
            <details open class="subcategories">
                    ...
                    @foreach($subcategories as $i => $sub)
                        <button data-sub="{{ $sub }}" aria-pressed="false">
                            <i class="mi" aria-hidden="true">
                                {{ ['sports_soccer','fitness_center','camping','sports_tennis','directions_bike','backpack'][$i] ?? 'sports' }}
                            </i>
                            {{ $sub }}
                        </button>
                    @endforeach
                ...
                @include('buyer.Category.Sports&Outdoors.components.sports-outdoors-filter')
        </aside>
        ...
        <main id="bc-main" tabindex="-1">
            ...
            <p class="subtitle">
                Gear up for training, travel, and the outdoors.
            </p>
    ...
    @include('buyer.Category.Sports&Outdoors.components.sports-outdoors-product-card')
