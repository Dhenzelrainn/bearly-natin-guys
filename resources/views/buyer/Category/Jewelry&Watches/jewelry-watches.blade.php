@php
    ...
    $jewelryCategory = collect($taxonomy)->firstWhere('slug', 'jewelry-and-watches');

    $subcategories = $jewelryCategory['subcategories'] ?? [
        'Necklaces',
        'Earrings',
        'Bracelets',
        'Rings',
...
<head>
    ...
    <title>Jewelry & Watches | Bearly</title>
...
<body class="bc" style="--catalog-image:url('{{ asset('images/jewelry-watches-catalog-atlas.png') }}')">
    ...
    <header class="bc-header">
        ...
        <form id="bc-search-form" class="search" role="search">
            ...
            <label class="sr" for="bc-search">Search Jewelry & Watches</label>
            <input id="bc-search" type="search" placeholder="Search Jewelry & Watches" maxlength="120">
    ...
    <div class="bc-shell">
        <aside class="bc-sidebar" id="bc-sidebar" aria-label="Categories and filters">
            ...
            <div class="active-category">
                <i class="mi" aria-hidden="true">diamond</i>
                    ...
                    @foreach($subcategories as $i => $sub)
                        <button data-sub="{{ $sub }}" aria-pressed="false">
                            <i class="mi" aria-hidden="true">
                                {{ ['diamond','earbuds','watch','radio_button_checked','watch','watch'][$i] ?? 'diamond' }}
                            </i>
                            {{ $sub }}
                        </button>
                    @endforeach
            ...
            @include('buyer.Category.Jewelry&Watches.components.jewelry-watches-filter')
        </aside>
        ...
        <main id="bc-main" tabindex="-1">
            ...
            <p class="subtitle">
                Timeless pieces for everyday style and special moments.
            </p>
    ...
    @include('buyer.Category.Jewelry&Watches.components.jewelry-watches-product-card')
